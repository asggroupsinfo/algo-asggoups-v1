...
class CommandRegistry:
    ...
    COMMANDS: Dict[str, CommandDefinition] = {
        ...
        "/settings": CommandDefinition("/settings", CommandCategory.SYSTEM, "Detailed settings menu", "handle_settings"),
        "/info": CommandDefinition("/info", CommandCategory.SYSTEM, "Bot and system information", "handle_info"),
        "/theme": CommandDefinition("/theme", CommandCategory.SYSTEM, "Change display theme/emojis", "handle_theme"),
        ...
        "/worstday": CommandDefinition("/worstday", CommandCategory.ANALYTICS, "Worst trading day analysis", "handle_worst_day"),
        "/correlation": CommandDefinition("/correlation", CommandCategory.ANALYTICS, "Pair correlation analysis", "handle_correlation"),
        "/dashboard": CommandDefinition("/dashboard", CommandCategory.ANALYTICS, "Live trading dashboard", "handle_dashboard"),
        "/export": CommandDefinition("/export", CommandCategory.ANALYTICS, "Export analytics data (CSV/JSON)", "handle_export"),
